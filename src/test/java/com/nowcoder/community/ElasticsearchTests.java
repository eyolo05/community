...
//        discussRepository.deleteById(231);
    ...
    public void testSearchByRespository() {
        ...
        // discussRepository.search(searchQuery)底层调用了此方法elasticTemplate.queryForPage()
        // 查到的数据由SearchResultMapper进行一个处理，想要把原始数据和高亮显示的数据组装在一起的话，需要使用此Mapper
        // 但是es底层并没有做这样的处理
        // 底层获取到了高亮显示的值，但是没有返回
        // 解决方法：自己重写es的某些方法，例如queryForPage()，但是很麻烦；
        // 或者，不用discussRepository.search()方法，直接使用elasticTemplate.queryForPage()方法
